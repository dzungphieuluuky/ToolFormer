...
def parse_function(row: pd.Series) -> Dict[str, Any]:
    ...
    tags = []
    keywords = ['KPI', 'alarm', 'traffic', 'coverage', 'subscriber', 'performance', 'configuration', 'topology']
    for kw in keywords:
...
if __name__ == "__main__":
    convert_csv_to_schema("data/raw/function.csv", "data/processed/function_schema.json")