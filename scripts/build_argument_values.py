...
# ── KPI codes ─────────────────────────────────────────────────────────────────
KPI_CODES = [
    {"code": "call_setup_success_rate",   "label": "Tỷ lệ thiết lập cuộc gọi thành công",         "group": "voice"},
    {"code": "call_drop_rate",            "label": "Tỷ lệ rớt cuộc gọi",                           "group": "voice"},
    {"code": "data_traffic_volume",       "label": "Lưu lượng dữ liệu",                             "group": "data"},
    {"code": "network_latency_avg_ms",    "label": "Độ trễ mạng trung bình (ms)",                   "group": "quality"},
    {"code": "service_cancellation_rate", "label": "Tỷ lệ hủy dịch vụ",                            "group": "service"},
    {"code": "voice_call_duration_avg",   "label": "Thời lượng cuộc gọi thoại trung bình (phút)", "group": "voice"},
    {"code": "data_usage_per_user_4g",    "label": "Mức sử dụng dữ liệu trung bình trên mỗi thuê bao 4G", "group": "data"},
    {"code": "active_user_count_4g",      "label": "Số lượng người dùng 4G hoạt động",              "group": "data"},
    {"code": "interruption_incident_count","label": "Số lượng sự cố gián đoạn dịch vụ",            "group": "quality"},
    {"code": "subscriber_growth_rate",    "label": "Tỷ lệ tăng trưởng thuê bao mới",               "group": "subscriber"},
    {"code": "coverage_percentage_4g",    "label": "Tỷ lệ phủ sóng 4G (%)",                        "group": "coverage"},
    {"code": "user_experience_score",     "label": "Điểm trải nghiệm người dùng",                   "group": "quality"},
]

# ── Location codes ────────────────────────────────────────────────────────────
LOCATION_CODES = [
    # National
    {"code": "VNM", "label": "Việt Nam",    "alt_label": "toàn quốc",           "group": "Toàn quốc"},
    # Regions
    {"code": "KV1", "label": "Khu vực 1",   "alt_label": "Khu vực miền Bắc",    "group": "Khu vực"},
    {"code": "KV2", "label": "Khu vực 2",   "alt_label": "Khu vực miền Trung",  "group": "Khu vực"},
    {"code": "KV3", "label": "Khu vực 3",   "alt_label": "Khu vực miền Nam",    "group": "Khu vực"},
    # Provinces
...
QUERY_TYPES = [
    {"code": "station_distance", "label": "Khoảng cách trung bình giữa các trạm", "group": "query_type"},
